...
const Header = () => {
      return (
        <header className="w-full flex px-15 py-2 text-white bg-blue-500  shadow-sm shadow-white/20 items-center justify-between min-h-16 sticky top-0 z-50">
            {/* Content Part  */}
             ...
             <div className="min-h-16 items-center flex font-bold gap-4">
                 <nav className="h-14 items-center flex font-bold gap-4">
                    <ul className="flex">
                        ...
                        <Link to="/login" className="px-5 py-3 cursor-pointer hover:bg-blue-600">Login</Link>
                    </ul>
                 </nav>
             </div>
        </header>
